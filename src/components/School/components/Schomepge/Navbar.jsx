    ...
    <nav className='bg-blue-100 md:px-14 p-4 max-w-screen-2xl border-b mx-auto text-primary fixed top-0 right-0 left-0 rounded-br-3xl rounded-bl-3xl'>
        <div className='text-lg container mx-auto flex justify-between items-center font-medium'>
            ...
            <div className='space-x-12 hidden md:flex items-center'>
                ...
                <a href="/" path="/"><button className='bg-blue-500 py-2 px-4 transition-all duration-300 rounded
                hover:text-white hover:bg-blue-900' onClick={handleLogout}>Sign Out</button></a>
            </div>
